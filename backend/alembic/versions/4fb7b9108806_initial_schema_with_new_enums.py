"""initial_schema_with_new_enums

Revision ID: 4fb7b9108806
Revises: 
Create Date: 2026-04-21 05:42:49.853719
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'ANALYZING_RESUME', 'ANALYSIS_COMPLETED', 'FAILED_ANALYSIS', 'INTERVIEW_IN_PROGRESS', 'COMPLETED', name='interview_status'), nullable=False),
