...
Revision ID: c6faf8b7ab43
Revises: 
Create Date: 2026-04-20 22:26:46.969400
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'ANALYZING_RESUME', 'ANALYSIS_COMPLETED', 'INTERVIEW_IN_PROGRESS', 'COMPLETED', name='interview_status'), nullable=False),
